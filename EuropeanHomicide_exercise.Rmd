...
As I can see we are definitely more civlised today than we were back centruries ago. This is shown in our visualisations from above. For instance, we can see that the homicide rate in Scandinavia was around 45 homicides per 100k people in 1450 while it today is close to 0 homicides per 100k people. Another example is the regent period of the danish monarchs. As we can see in the second visualisation it clearly shows the regency period generally has increased during the centruies. This indicates that the monarchs have lived lives. A reason for that could maybe be more civilisation. 